...
export class AuthService implements AuthUseCase {
    ...
    public async login(dto: LoginDTO): Promise<LoginResponseDTO> {
        ...
        return new LoginResponseDTO(new UserDTO(user.userId, user.nickName, user.nome, user.telefone, user.permissions), new PermissinSecurityDTO(hashAccessToken, hashRefreshToken));
    }
