...
(async () => {
    ...
    const estoqueService = new EstoqueService(logger, estoqueRepositiory, acaoSocialTemplate, itemTemplateRepository, templateRepository, cestaGeradaRepository, unitOfWork);
    ...
    const gerarCestasService = new GerarCestasService(logger, templateRepository, cestaGeradaRepository, estoqueRepositiory, estoqueService);
