...
import { NotificarAgenteProdutoVencimentoService } from "./application/service/NotificarAgenteProdutoVencimentoService";
import { VisualizarProdutosProxVencimentoService } from "./application/service/VisualizarProdutosProxVencimentoService";
...
export async function buildApp() {
    ...
    const itemRepository = new ItemProdutoPostgresDatabase(postgresDatabase);
    const tempDataRepository = new TempDataPostgresDatabase(postgresDatabase);
    ...
    const estoqueService = new EstoqueService(logger, estoqueRepositiory, itemTemplateRepository, templateRepository, cestaGeradaRepository, cestaEstoqueItemRepository, unitOfWork);
    ...
    new WebhookWhatsappController(httpClient, visualizarProdutosProxVencimentoService, tempDataRepository);
