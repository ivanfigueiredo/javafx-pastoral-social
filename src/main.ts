...
(async () => {
    ...
    const gerarCestasService = new GerarCestasService(logger, templateRepository, cestaGeradaRepository, estoqueRepositiory, cestaEstoqueItemRepository, estoqueService);
    ...
    new AjudaController(httpClient, auth, authorize, associarAjudaFamiliaService, cancelarAjudaService);
